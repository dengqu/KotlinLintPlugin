...
public class TooManyLinesOfCodeFileCheck implements ICheck {
    private static final int DEFAULT_MAX = 1000;
    private static final String DEFAULT_MAX_VALUE = "" + DEFAULT_MAX;
    private static final SIssue sIssue = new SIssue.SIssueBuilder().issueId("TooManyLinesOfCodeFileCheck")
