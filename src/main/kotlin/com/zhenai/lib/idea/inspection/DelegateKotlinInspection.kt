 ...
 * @date 2017/02/28
 */
class DelegateKotlinInspection : LocalInspectionTool(), AliBaseInspection, PmdRuleInspectionIdentify {

    private val ruleName: String? = null

    private val aliPmdInspection: AliKotlinInspection

    init {
        aliPmdInspection = AliKotlinInspection(ruleName!!)
    }
